...
* `cm_to_inch_feet.py` - Converts centimeters to inches and feet.
* `dice_problem.py` - Calculates the probability distribution of dice sums.
* `dice_rproblemv2.py` - A 5-round dice game simulation between two players.
...
* `kg_to_stones_and_pounds.py` - Converts kilograms to British stones and pounds.
* `lists.py` - Calculates the average rating of visited countries from a list.
* `password_generator.py` - Generates a random password.
* `print("Hello World").py` - A basic hello world print script.
* `random_test.py` - Generates random numbers based on specific conditions.
* `suitcae.py` - Calculates how many banknotes fit into a suitcase.
* `thickness.py` - Calculates the physical height of one billion dollars in $100 bills.

## How to Run

Open your terminal and run the scripts using Python:
